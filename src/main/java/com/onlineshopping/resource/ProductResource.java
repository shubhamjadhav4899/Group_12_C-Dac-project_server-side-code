...
public class ProductResource {
	...
	public void deleteProduct(int productId) throws ProductNotFountException {
        Product product = productDao.findById(productId).orElseThrow(()->new ProductNotFountException("Delete operation failed"));
        productDao.deleteCartsByProduct(product);
